...
import org.research.project.examples.classification.env.ImageUtils;
import org.research.project.examples.classification.env.Logger;
import org.research.project.examples.classification.tflite.Classifier;
...
public abstract class CameraActivity extends AppCompatActivity
  ...
  protected void onCreate(final Bundle savedInstanceState) {
    ...
    captureBtn = findViewById(R.id.freezeBtn);
  ...
  public void changeCaptureState(View view) {
    if(captureStatus){
      captureStatus=false;
    ...
    String str = recognition.getTitle();
    String[] splited = str.split(" ");

    frameValueTextView.setText(splited[0]);
    frameValueTextView.setText(splited[1]);
...
//    System.out.println(splited[3]);
    ...
    Intent intent=new Intent(getApplicationContext(), DetailsShow.class);
    intent.putExtra("VALUE", recognitionValueTextView.getText());
